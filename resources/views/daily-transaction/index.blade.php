                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            {{-- Modal Create --}}
                            @include('daily-transaction.create')
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="datatable-1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="5%">{{ $no }}</td>
                                            <td width="10%">{{ $value->rekening->kode_rek }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a class="iq-icons-list text-danger"
                                                    href="{{ url('/daily-transaction/delete/' . base64_encode($id)) }}"
                                                    title="Delete">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="currentColor" class="w-6 h-6">
                                                        <path fill-rule="evenodd"
                                                ...
                                                {{-- Modal Edit --}}
                                                @include('daily-transaction.edit')
                                            </td>
                                        </tr>
                                        <?php 
                                            $no += 1;
